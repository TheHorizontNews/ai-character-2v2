...
import { Home, TrendingUp, Heart, Users, Crown, Sparkles, Menu, X, ChevronRight, Compass, GitCompare, List } from 'lucide-react';
...
const Sidebar = ({ activeSection, onSectionChange }) => {
  ...
  const menuItems = [
    ...
    { id: 'compare', icon: GitCompare, label: 'Compare', path: '/compare' },
    { id: 'all-comparisons', icon: List, label: 'All Comparisons', path: '/all-comparisons' },
